...
| [`wav2vec2_fine_tune/`](wav2vec2_fine_tune/) | [HF blog: Fine-Tune Wav2Vec2 for English ASR](https://huggingface.co/blog/fine-tune-wav2vec2-english) + TIMIT phoneme recognition | Both steps trained — **WER 28.69%** (ASR) and **PER 11.52%** (phonemes) on TIMIT core test |
